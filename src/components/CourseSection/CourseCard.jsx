...
const CourseCard = ({course}) => {
  return (
    <div className=' w-[30%] m-3 px-3 py-5  break-words  rounded-md shadow-2xl'>
       ...
       <p><a href="https://youtu.be/7wnove7K-ZQ" className='bg-purple-700 px-2 py-2 text-white rounded-full hover:bg-purple-600'>{course.link}</a></p>
    </div>
  )
}
